...
public class _03_String02 {
	...
	public static void main(String[] args) {
		...
		// String은 space값도 문자열값으로 인식(index로 인식한다.)
		...
		// 포함되어 있으면 해당문자의 인덱스를 찾아서 리턴, 포함되어 있지 않으면 -1 리턴
		...
		System.out.println("str3에서 h의 마지막 h의 index는: " + str3.lastIndexOf('b'));
		...
		// 배열에서는 length가 메소드가 아니고 속성값(멤버변수)이다.
		...
		// 4. replace, replaceAll: 문자열에서 주어진 첫번째 매개변수를 찾아서 두번째 매게변수로 치환하는 메소드
		// replace와 replaceAll의 차이는 replacAll은 정규표현식을 매개변수로 전달할 수 있다는 점이다.
		...
		// 5. 체이닝 기법
		// 메소드를 체인처럼 엮어서 사용하는 것을 '체이닝 기법' 이라고 한다.

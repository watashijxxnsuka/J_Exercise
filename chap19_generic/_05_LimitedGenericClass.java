...
public class _05_LimitedGenericClass {
	...
	public static void main(String[] args) {
		...
		// LimitedRamyun01 클래스에 제한을 걸어둔 Gimchi 를 상속받은 클래스와
		// Gimchi 클래스까지 서브클래스의 타입으로 지정할 수 있다.
		LimitedRamyun01<Gimchi> gimchiRamyun = new LimitedRamyun01<Gimchi>();
		LimitedRamyun01<PaGimchi> paGimchiRamyun = new LimitedRamyun01<>();
		
		// Gimchi 를 상속받지 않은 Danmuji 는 서브클래스의 타입으로 지정할 수 없다.

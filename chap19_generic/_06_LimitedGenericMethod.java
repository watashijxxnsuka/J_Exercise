...
//		strList.add("30");
		...
		// Number 클래스를 상속받지 않은 String 타입으로 지정할 수 없다.
//		System.out.println(sumList(strList));
		...
		// String 타입으로 지정할 수 없다.
//		System.out.println(getSumMap(strMap));
		
	}
	
	// 1. 제네릭 클래스와 마찬가지로 제네릭 메소드에도 extends 키워드로 지정할 타일에 대한
	// 제한을 걸 수 있다.
	// extends 로 제한된 제네릭에서는 부모클래스가 지정되어 있기 때문에,
	// Object 의 메소드 뿐만 아니라 지정된 부모클래스의 메소드도 사용이 가능하다.
